...
const { getDataFiltered, getSortedData, generateIndex, getKasKus } = require('./helpers');
const port = 3000
...
app.get('/', function (req, res, next) {
    ...
    if (params.length > 0 || paramsDate.length > 0) {
        ...
        dataFiltered = getDataFiltered(data, params[0] ? params : [{}], paramsDate).splice(offset, limit)
    } else {
        total = data.length
